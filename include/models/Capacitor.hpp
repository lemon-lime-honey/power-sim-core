...
class Capacitor {
 public:
  Capacitor(std::string name, int fromBus, int toBus, double nominalVoltage,
  ...
  Capacitor(std::string name, int bus, double nominalVoltage,
            double ratedCapacity)
      : Capacitor(std::move(name), bus, 0, nominalVoltage, ratedCapacity) {}
